...
<div class="container" style="max-width: 728px; margin: 0 auto;">
  ...
  <form action="{{ url('posts/'.$post->id) }}" method="post"  enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input id="fishing_day" type="number" class="form-control  @if ($errors->has('fishing_day')) is-invalid @endif" name="fishing_day" placeholder="20200101" value="{{ old('fishing_day', $post->fishing_day) }}">
